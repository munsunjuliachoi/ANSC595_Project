...
setwd("~/Desktop/Project/core-metrics-results/")
...
bc_PCoA<-read_qza("~/Desktop/Project/core-metrics-results/bray_curtis_pcoa_results.qza")
...
ggplot(bc_meta, aes(x=PC1, y=PC2, color=get("treatment"))) +
...
ggplot(bc_meta, aes(x=PC1, y=PC2, color=get(my_column))) +
  ...
  ylab(paste0("PC2 (", round(100*bc_PCoA$data$ProportionExplained[2], digits = 2), "%)")) +
  scale_color_manual(values=body_colors)
ggsave(paste0("output/BC-ellipse_", my_column,".pdf"), height=2, width=3, device="pdf") # save a PDF 3 inches by 4 inches
...
Wuni_PCoA<-read_qza("~/Desktop/Project/core-metrics-results/weighted_unifrac_pcoa_results.qza")
...
ggplot(Wuni_meta, aes(x=PC1, y=PC2, color=get(my_column))) +
  ...
  scale_color_manual(values=body_colors)
ggsave(paste0("output/Wuni-ellipse_", my_column,".pdf"), height=2, width=3, device="pdf") # save a PDF 3 inches by 4 inches
